...
최종 업데이트: 2026-04-11 KST — 세션 20 (youtube-analysis 프레임+자막 통합 분석)
읽기 순서: **TASKS.md → STATUS.md → HANDOFF.md** → CLAUDE.md → 도메인 CLAUDE.md

---

## 0. 최신 세션 (2026-04-11 세션 20)
...
6. **시스템 설치**: yt-dlp + ffmpeg (winget)

### 다음 세션 안건
1. 캐시 TTL/용량 상한 (GPT 보류 건)
2. 취약점 동결 3건 계속 모니터링

---

## 1. 이전 세션 (2026-04-11 세션 19)
