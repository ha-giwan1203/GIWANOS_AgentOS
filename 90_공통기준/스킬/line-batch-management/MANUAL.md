# line-batch-management — MANUAL

> 메인서브 + OUTER 통합 매핑 / JS 함수 등록 / 실행 절차 / 검증. SKILL.md는 호출 트리거 + 80줄 요약.
> 분리 도구: `line-batch-mainsub` (메인서브 전용) / `line-batch-outer-main` (OUTER/MAIN 전용)
