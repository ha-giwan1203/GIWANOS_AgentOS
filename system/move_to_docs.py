...
def move_files_to_docs(base_dir, target_folder, pattern):
...
def main():
    print("📂 'docs' 폴더로 .md 파일 자동 정리 시작...\n")

    moved_files, errors = move_files_to_docs(BASE_DIR, TARGET_FOLDER, FILE_PATTERN)
