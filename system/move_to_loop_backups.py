...
BASE_DIR = "C:/giwanos"
TARGET_FOLDER = os.path.join(BASE_DIR, "loop_backups")
FILE_PATTERN = "*.zip"

def move_files_to_loop_backups(base_dir, target_folder, pattern):
...
def main():
    print("📂 'loop_backups' 폴더로 (.zip) 파일 자동 정리 시작...\n")

    moved_files, errors = move_files_to_loop_backups(BASE_DIR, TARGET_FOLDER, FILE_PATTERN)
