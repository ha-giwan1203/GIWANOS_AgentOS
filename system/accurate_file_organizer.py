...
FILE_MOVES = {
    "evaluation_aggregated_log.jsonl": "logs",
    "giwanos_log_report.html": "reports"
}

def organize_files(base_dir, file_moves):
    moved_files = []
    errors = []
...
def main():
    print("📂 정확한 파일 위치로 이동 정리 시작...\n")

    moved_files, errors = organize_files(BASE_DIR, FILE_MOVES)
