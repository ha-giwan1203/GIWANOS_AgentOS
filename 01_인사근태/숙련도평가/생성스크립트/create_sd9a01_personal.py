...
# SD9M01 공정번호 → 양식 공정번호 (라인별공정목록.xlsx 기준 10단위 + 신규 21)
# 사용자 결정 2026-04-27: ERP 표준공정원직(SD9A01_001~011) 대신 라인별공정목록 번호 사용
SD9M01_TO_ERP = {
    '10':  '10',
    '20':  '20',
    '21':  '21',   # 신규 RETRACTOR MAIN FRAME 서브 앗세이 압입 & 리벳 & 릴 하단 브라켓
    '30':  '30',
    '40':  '40',
    '50':  '50',
    '60':  '60',
