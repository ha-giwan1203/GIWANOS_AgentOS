...
class Settings:
    ...
    def resolve_path(
        self, key: str, default: Optional[StrPath] = None, required: bool = False
    ) -> Path:
    ...
    def get_logging_config(self) -> Dict[str, Any]:
        ...
        path, _ = self.resolve(
            "logging.path",
            str(Path(self.resolve_path("VELOS_ROOT", required=True)) / "data" / "logs"),
        )
        ...
        json.dumps(
            {
                ...
                "vectors": {
                    ...
                    for k, v in cfg.get("vectors", {}).items()
                },
            },
            ensure_ascii=False,
            indent=2,
