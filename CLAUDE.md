...
- **질문 허용 2조건 (그 외 묻기 금지)** (2026-05-08 세션148 근본 해결, 5→2 축약): (1) ERP/MES/SmartMES 비가역 반영 직전 대상/일자/라인/건수 1줄 확인 (2) 사용자 명시 선택 요구 ("물어봐"·"확인해"·"어떻게 할까"). 폐기 3조건: 필수 입력값 부재(모호함을 부재로 해석 남용) / 기준 vs 실물 충돌(자체 우선순위 적용) / C 모드 전환(R1·R5로 흡수). 자세한 근거는 `feedback_authority_ladder.md`.
...
**위임 떠넘기기 금지** — 결정·실행을 사용자에게 미루는 행위 금지: 옵션 나열 후 선택 요구 / "어떻게 할까요" / "진행할까요" / "A/B 중 선택" / "원하시면" / "사용자 결정 대기" / "1단어 응답 부탁". 판단을 먼저 제시 후 비가역 작업 직전 1줄 확인만 허용. 판단·추론·대안 제시·반론은 떠넘기기 아니며 적극 허용.
