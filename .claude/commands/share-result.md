...
| **환경 미스매치** | 제조업 G-ERP 환경에 안 맞거나 현재 구조에서 유효성 없음 | "경고 상위 대상 변동" — 현재 STRONG이 1건뿐 |
| **메타 순환** | 제안이 해결하려는 문제와 동일한 문제를 지표로 재정의 | "Phase 2 진입 지표 = Phase 2 자체 목적" |
| **구현 경로 미정** | 방향은 타당하나 자동화·측정 방법 미제시 | "조치 전환율" — 자동 감지 로직 없음 |
