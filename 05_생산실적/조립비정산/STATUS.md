# 조립비 정산 진행 현황 (2026-04-05 최신화)

## 현재 상태
- 운영 파일: 정산결과_03월.xlsx (04월 폴더, 신규 실적 데이터 기반)
...
- 오류리스트: 04월/오류리스트_03월.xlsx (261건, step8 자동 생성)
...
## 3월 정산 결과 — 04월 폴더 최신본 (2026-04-05, 신규 데이터)
...
| **합계** | **261,597,177** | **244,454,138** | **+17,143,039** | |

### 데이터 검증 (2026-04-05)
- Step5 JSON ↔ Excel Row 21-31 (GERP vs 구ERP): **10개 라인 전체 0원 차이** (PASS)
- 오류리스트: step5 error_list 261건 = 오류리스트_03월.xlsx 261건 (일치)
- 산출물: 정산결과_03월.xlsx (13시트) + 오류리스트_03월.xlsx (2시트)
