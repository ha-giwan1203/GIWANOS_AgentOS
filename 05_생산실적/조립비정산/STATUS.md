...
## 3월 정산 결과 — 04월 폴더 최신본 (2026-04-05, 기준정보 갱신 후 재실행)
| 라인 | GERP정산 | 구ERP정산 | GERP-구ERP차이 | 비고 |
|------|---------|---------|--------------|------|
| SD9A01 | 109,117,529 | 109,116,382 | +1,147 | |
| SP3M3 | 80,304,519 | 68,333,737 | +11,970,782 | 구ERP야간=GERP야간 적용 |
| WAMAS01 | 38,266,302 | 34,891,030 | +3,375,272 | |
| WABAS01 | 11,921,269 | 11,892,669 | +28,600 | |
| ANAAS04 | 3,976,580 | 2,594,402 | +1,382,178 | |
| DRAAS11 | 1,551,188 | 1,551,188 | 0 | 일치 |
| WASAS01 | 314,800 | 308,532 | +6,268 | |
| HCAMS02 | 13,148,898 | 10,831,001 | +2,317,897 | |
| HASMS02 | 1,709,640 | 1,742,220 | -32,580 | |
| ISAMS03 | 727,446 | 341,341 | +386,105 | |
| **합계** | **261,038,171** | **241,602,502** | **+19,435,669** | |

### 데이터 검증 (2026-04-05, 기준정보 갱신 후)
- Step6 검증: **PASS** (CRITICAL 0 / WARNING 0 / INFO 2)
- GERP 원본금액 정합성: PASS
- 오류리스트: 282건 (구실적누락 98 / GERP누락 86 / 수량차이 96 / 정산차이 2)
- 산출물: 정산결과_03월.xlsx (14시트) + 오류리스트_03월.xlsx (282건)
- 변경: 기준정보 X9000/X9500 이관 품번 삭제 + Usage/RSP/단가 수정 반영
