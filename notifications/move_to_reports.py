...
BASE_DIR = "C:/giwanos"
TARGET_FOLDER = os.path.join(BASE_DIR, "reports")
FILE_PATTERN = "*.pdf"

def move_files_to_reports(base_dir, target_folder, pattern):
...
def main():
    print("📂 'reports' 폴더로 (.pdf) 파일 자동 정리 시작...\n")

    moved_files, errors = move_files_to_reports(BASE_DIR, TARGET_FOLDER, FILE_PATTERN)
