...
```bash
ls 05_생산실적/조립비정산/{MM+1:02d}월/라인정지_{MM}월_raw.xlsx
```
...
- 산출물 2종:
  - `05_생산실적/조립비정산/{MM+1:02d}월/라인정지_{MM}월_raw.xlsx` (raw + 집계 시트)
  - `05_생산실적/조립비정산/{MM+1:02d}월/라인정지_{MM}월_요약.md`
...
2. `05_생산실적/조립비정산/{MM+1:02d}월/라인정지_{MM}월_raw.xlsx` 저장
...
## 작업폴더 관행
- 매월 정산 작업폴더 = `05_생산실적/조립비정산/{MM+1:02d}월/` (조립비정산과 동일)
