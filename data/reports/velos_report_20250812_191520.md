...
- 최근 요약: 최근 메모리 항목 19개 중 대표: 파일명은 절대 변경하지 않는다., 검증되지 않은 결과는 배포하지 않는다., loop_heartbeat, loop_heartbeat, loop_heartbeat, loop_heartbeat, 마스터 루프 중심 고정, 실시간 메모리 반영, 데이터 근거 기반 보고서/알림 자동화,…, 설계 전
- 요약 생성 시각: 2025-08-12T19:15:20
- 소스 카운트: LM=11, DM=4, INBOX=4
...
- [info] 2025-08-12T19:04:48 (reflections_index_norm.json)
